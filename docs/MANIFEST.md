...
| `tmi_lean_formal_library_0_1/lean/TMI/ClaimPassport.lean` | TLFL 0.2 claim passport, certificate, public surface, audit-sheet layer, and review gate |
...
| `TMI.ClaimPassport` | Claim passport, proof-state certification, public certificate surface, audit sheet, and review gate |
...
| Source author | `kernelpanic888 <48477233+kernelpanic888@users.noreply.github.com>` |
| License | `Apache-2.0` |
